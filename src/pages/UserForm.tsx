  ...
  return (
    <div>
      <div className="flex items-center gap-3 mb-8">
        <Button variant="ghost" size="icon" className="h-8 w-8 shrink-0" asChild><Link to="/users"><ArrowLeft className="h-4 w-4" /></Link></Button>
      ...
      <div className="grid gap-6 max-w-2xl">
        ...
        <div className="flex justify-end gap-3 pb-8">
          <Button variant="outline" asChild><Link to="/users">Cancel</Link></Button>
          <Button onClick={() => navigate("/users")} size="lg">{isEdit ? "Save Changes" : "Create User"}</Button>
        </div>
      </div>
    </div>
  );
