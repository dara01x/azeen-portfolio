...
const SettingsPage = () => {
  ...
  return (
    <div>
      <PageHeader title="Settings" description="Configure system permissions" />
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            <div className="flex items-center justify-between">
              <div>
                <Label>Allow companies to create properties</Label>
            ...
            <div className="flex items-center justify-between">
              <div>
                <Label>Allow companies to edit properties</Label>
