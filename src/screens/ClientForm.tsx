    ...
    <div>
      <div className="flex items-center gap-3 mb-8">
        ...
        <div className="flex gap-2">
          ...
          <Button onClick={() => router.push("/clients")}>{isEdit ? "Save Changes" : "Create Client"}</Button>
        </div>
      </div>
      <div className="grid gap-6 max-w-2xl">
        ...
        <div className="flex justify-end gap-3 pb-8">
          <Button variant="outline" asChild><Link href="/clients">Cancel</Link></Button>
          <Button onClick={() => router.push("/clients")} size="lg">{isEdit ? "Save Changes" : "Create Client"}</Button>
        </div>
      </div>
    </div>
  );
